...
export const FUTURE_TOOLS = [
  {
    ...
    description: "Find brittle prompts before they fail in production loops.",
  },
  {
    name: "Session Context Pressure Meter",
    description: "Estimate context growth and identify truncation risk early.",
  },
  {
    name: "Agent Config Sanity Checker",
    description: "Lint OpenClaw config files for runaway-cost settings.",
  },
];
